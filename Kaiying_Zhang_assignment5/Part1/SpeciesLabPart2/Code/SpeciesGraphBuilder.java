...
public class SpeciesGraphBuilder {
	...
	public static void runJob(String input) throws IOException {
		...
		String output="xml_output_species_builder";
		...
		SpeciesIterDriver2 driver=new SpeciesIterDriver2(output,5);
	}
